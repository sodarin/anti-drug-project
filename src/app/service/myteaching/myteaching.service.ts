...
//创建课程
  ...
  //取消收藏题目
  deleteMyFavorite(questionId:number, targetId: number, userId: number): Observable<any> {

    return this._http.delete(`/user/cancelCollection?questionId=${questionId}&targetId=${targetId}&userId=${userId}`)
  }
