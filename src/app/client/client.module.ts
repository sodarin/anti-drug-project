...
@NgModule({
  declarations: [TeacherComponent, ClientComponent, DashboardComponent, CourselistComponent, PersonalSettingsComponent, ClasslistComponent, InformationComponent, VerificationComponent, SecuritySettingComponent],
  imports: [
    ShareModule,
    CoreModule,
    RouterModule,
