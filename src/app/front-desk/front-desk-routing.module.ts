...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      {
        path: "mine",
        component: MineManagementComponent,
        children: [
      ...
      {
        path: "openresourcedetail/:id",
        component: OpenresourcedetailComponent,
      },
      {
        path: "groupmainlist",
        component: GroupmainlistComponent,
        children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "groupthread/:id/groupthreadedit",
            component: GroupthreadeditComponent,
          },
        ],
      },
      ...
      {
        path: "testpaper/:paperid/result/:studentid",
        component: PaperResultDetailComponent,
      },
      {
        path: "course/:courseid/analysis/:courseTaskId",
        component: PaperResultAnalysisComponent,
      },
      {
        path: "tidings",
        component: TidingsComponent,
        children: [
      ...
      {
        path: "course/:id/teaching_plan_page/:pid",
        component: TeachingPlanPageComponent,
        children: [
          ...
          {
            path: "papers/:paperid/resulttable",
            component: TestResultTableComponent,
          },
